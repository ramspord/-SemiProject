                        ...
                        <div class="card mb-4">
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <br>
                                    <!-- 이 위치에 카트에 담기 버튼 -->
                                    <a href="#" class="btn btn-primary" onclick="insertBasket(16)">카트에 담기</a>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <!-- 이 위치에 사진 -->
                                    <img src= "images/gallery/fulls/royal.jpg">
                                    <br>
                                    <!-- 이 위치에 카트에 담기 버튼 -->
                                    <a href="#" class="btn btn-primary" onclick="insertBasket(11)">카트에 담기</a>
                                </div>
                            </div>
