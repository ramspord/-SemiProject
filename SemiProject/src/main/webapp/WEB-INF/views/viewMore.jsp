...
<html lang="en">
    <head>
        ...
        .page-header{font-family: 'Dongle', sans-serif; font-size: 30px;}
        </style>
        ...
        function deleteConfirm(){
        	...
        	if(!confirm("삭제 하시겠습니까?")){
        		...
        		location.href="${pageContext.request.contextPath }/boardDelete?no=${Contents.no}";
        	}
        }
        </script>
    </head>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							...
							<div class="col-lg-12">
							<h1 class="page-header">글 상세보기 페이지</h1>
							</div>
							</div>
							...
							<div style="margin-left:1px;">
								...
								<a href="update?no=${Contents.no}" class="btn btn-success">수정</a>
