                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							...
							<form role="form" action="updateArticle" method="post" onsubmit="return _onSubmit();">
							<input type="hidden" id="no" name="no" value="${Contents.no }"/>
									...
									<tbody>
										...
										<tr>
											...
											<td class="form-inline"><textarea 
													...
													class="form-control">${Contents.content }"</textarea></td>
										</tr>
									</tbody>
								</table>
							</div>
							<div style="margin-left:1px;">
								...
								<a href="viewMore?no=${Contents.no}" class="btn btn-danger">취소</a>
							</div>
							</form>
							</div>
							</div>
